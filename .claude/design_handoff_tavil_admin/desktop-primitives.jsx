...
// SectionHead — editorial-style section header (kicker accepted but ignored for unified look)
...
// Page header used at top of each screen — unified, no kicker eyebrow
function DPageHeader({ title, subtitle, actions, style }) {
  const { theme } = useDApp();
  return (
    <div style={{
