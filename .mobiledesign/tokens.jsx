...
window.TAVIL_DATA = {
  ...
  notifications: [
    { id: 'no1', title: 'Nova política de teletreball publicada', time: 'fa 1 h', unread: true },
    { id: 'no2', title: 'La teva sol·licitud ha estat aprovada', time: 'fa 3 h', unread: true },
    { id: 'no3', title: 'Et conviden a "Formació CRM"', time: 'ahir', unread: false },
  ],
};
